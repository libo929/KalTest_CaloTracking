...
Double_t EXKalDetector::fgBfield = 3.5;
             ...
             : TVKalDetector(m)
{
   ...
   static const Int_t    nlayers   = 220;        // # sampling layers 
   ...
   static const Double_t rcylin    = 280.;       // inner radius of CFRP cylinder 
   static const Double_t rcylout   = 290.;       // outer radius of CFRP cylinder
